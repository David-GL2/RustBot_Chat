...
**🔗 Demo en vivo:** [ENLACE-AQUI](#) — corre sobre hardware personal, así que puede tardar unos segundos en despertar o estar puntualmente offline (ver [Estado del proyecto](#estado-del-proyecto)).
